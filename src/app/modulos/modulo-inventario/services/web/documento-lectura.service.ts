...
export class DocumentoLecturaService {
  constructor
  (
  ...
  getListDocumentoPendienteByObjTypeAndCardCode(value: FilterRequestModel) {
    ...
    return this.http.get<IDocumento[]>(`${environment.url_api_fib}DocumentoLectura/GetListPendienteByObjTypeAndCardCode/`,{params: params});
  }
}
