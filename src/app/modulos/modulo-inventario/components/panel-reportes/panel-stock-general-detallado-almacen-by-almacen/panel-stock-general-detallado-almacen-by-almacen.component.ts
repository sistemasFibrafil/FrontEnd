...
export class PanelStockGeneralDetalladoAlmacenByAlmacenComponent implements OnInit {
  modeloForm: FormGroup;

  // Titulo del componente
  titulo = 'Reporte - Stock General Detallado por Almacén';
  ...
  ngOnInit() {
    ...
    this.buttonAcces = this.accesoOpcionesService.getObtieneOpciones('app-inv-panel-stock-general-detallado-almacen-by-almacen');
    ...
    [
      ...
      { field: 'unidadInventario',  header: 'UM' },
  ...
  onListar() {
    ...
    this.list = [];
    this.onSetParametro();
    this.articuloSapService.getListStockGeneralDetalladoAlmacenByAlmacen(this.params)
  ...
  onToExcel() {
    this.isDisplay = true;
    this.onSetParametro();
    this.articuloSapService.getStockGeneralDetalladoAlmacenByAlmacenExcel(this.params)
