...
@Component({
  ...
  templateUrl: './panel-transferencia-stock-update.component.html',
  styleUrls: ['./panel-transferencia-stock-update.component.css']
})
export class PanelPanelTransferenciaStockUpdateComponent implements OnInit {
